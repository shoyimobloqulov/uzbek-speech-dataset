...
if __name__ == '__main__':
    ...
    table.add_row(
        "This tool extracts texts from the sample folder, splits them into sentence and creates a metadata.csv to be used with the generator.")
    table.add_row("2021 - SHO")
    ...
    console.print("%d sentence written to %s. These are approximately %s of audio." % (
    len(all_sentences), csv_file_name, duration))